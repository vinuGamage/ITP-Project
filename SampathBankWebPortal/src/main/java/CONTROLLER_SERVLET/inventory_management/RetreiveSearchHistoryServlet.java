...
/**
 * Servlet implementation class RetreiveSearchHistoryServlet
 */
public class RetreiveSearchHistoryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RetreiveSearchHistoryServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			ArrayList<HistoryItem> historyList= RetreiveDAO.retreiveSearchHistory(request.getParameter("search"));
