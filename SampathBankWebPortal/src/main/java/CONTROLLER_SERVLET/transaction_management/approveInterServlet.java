...
/**
 * Servlet implementation class approveInterServlet
 */
public class approveInterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public approveInterServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Transaction t1 = list.get(Integer.parseInt(request.getParameter("approve")));
