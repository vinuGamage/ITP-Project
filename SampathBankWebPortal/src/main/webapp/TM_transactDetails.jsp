        ...
        <div class="container-fluid" style="height: 850px ">
            ...
            <div class="row">
             ...
             <div class="col-sm-10">
                 ...
                 <div align="center">
                            <br><br><br>
                            <p style="center:2%;font-size:35px;color:#565554;font-weight:Bold;margin-left:200px">Your Transaction Details</p>
                            
                        </div>
                        <div align="center">
                            <form  name="interBankTransaction" action = "transConfirmServlet" method="POST" >
                        	<fieldset =disabled>
                            <table align="center" style="color:black;center: 10%;font-size:20px;margin-left:370px" cellpadding="5px" cellspacing="5px">
                        	
                            <%Transaction t = (Transaction)session.getAttribute("InterTransacts"); %>
                           
                            
                            <tr> <th style = "text-align: left" >Account No &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  :</th>
                                 <td colspan="2" align="right"><input name="accountno" readonly value= <%=t.getAccountNo()%> >
                            </td>
                            </tr>
                            
                            <tr><th style="text-align:left" >Target Account No &nbsp  : </th>
                                <td colspan="2" align="right"><input name="Taccountno" readonly value = <%=t.getTaccountNo()%> > 
                            </td>
                            </tr>
                            
                            
                            
                            <tr><th style="text-align:left" >Date &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  : </th>
                                <td colspan="2" align="right"><input name="dateTime" readonly value= <%=t.getDate() %> >
                            </td>
                            </tr>
                            
                            
                            
                            <tr><th style="text-align:left" >Amount &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp    : </th>
                                <td colspan="2" align="right"><input name="amount" readonly value=<%=t.getAmount()%> >
                            </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" align="right">  <input type="submit" value="Confirm"  class="btn"  style="background-color:#D3D3D3	;color:black;font-weight:bold""> 
                            </td>
                            </tr>
