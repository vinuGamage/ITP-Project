        ...
        <br>
			...
			<table style="text-align: left;margin-left: 0px" cellpadding="10px" cellspacing="20px" align="center">
				<tr>
					...
					<td><input class = "form-control form-control-sm" type="text" name="path" placeholder="Enter the File Name"   required></td>
				...
				<tr>
					...
					<td><input class = "form-control form-control-sm" type="text" name="transId" placeholder="Enter the Transaction ID" value="0"  ></td>
					
				
				</tr>
				
				<tr>
					<td>Enter Source Account :</td>
					<td><input class = "form-control form-control-sm" type="text" name="srcAccount" placeholder="Enter the Source Account" value="0"  ></td>
					
				
				</tr>
				<tr>
					<td>Enter Target Account</td>
					<td><input class = "form-control form-control-sm" type="text" name="tarAccount" placeholder="Enter the Target Account" value="0"  ></td>
					
				
				</tr>
				<tr>
					<td>Enter Amount</td>
					<td><input class = "form-control form-control-sm" type="text" name="amount" placeholder="Enter the Amount" value="0"  ></td>
				...
				<tr>
					<td>Enter Month : </td>
					<td><input class = "form-control form-control-sm" type="month" name="month" value=""  ></td>
				...
				<tr>
				<td colspan="1"><input type="submit" value ="Gernerate Overall Report" class="btn btn-dark btn-sm" name="submit1"></td>
				<td colspan="1"><input type="submit" value ="Gernerate Specific Report" class="btn btn-dark btn-sm" name="submit2"></td>
				</tr>
