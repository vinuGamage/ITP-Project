...
<html lang="en">
    ...
    <body>
            ...
            <div class="header-mid">
                <a href="#" title="Go to Sampath Web Site">
                    <div class="container-fluid img-div">
                        <img src="resources/images/SampathBankLogo01.png" alt="" class="logo">
                    </div>
                </a>
        ...
        <div class="container" style="height: 500px">
                 <div align="center">
                            <br><br>
                            <p style="center:2%;font-size:35px;color:black;margin-left:200px">Employee Login</p>
                            
                        </div>
                        <div align="center">
                            <form  name="login" action = "transactServlet" method="POST" >
                            ...
                            <tr><th style = "text-align: left">Username &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  :</th>
                                 <td colspan="2" align="right"><input class = "form-control form-control-sm" type="text" name="user" placeholder="Username"   required> 
                            </td>
                            </tr>
                            
                            <tr><th style="text-align:left">Password &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp: </th>
                                <td colspan="2" align="right"><input class = "form-control form-control-sm" type="password" name="pass" placeholder="Password"   required> 
                            </td>
                            </tr>
