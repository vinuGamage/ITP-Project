            ...
            <div class="row">
             ...
             <div class="col-sm-10">
                  <div class = "container" >
 						<div align="center">
							<br><br><br><br>		
								<p style="center:2%;font-size:35px;margin-left:300px">Enter Your pin ID</p>
						</div>
					<div style= margin-left:300px  align="center">
						<form  name="pin1" action = "accBalanceServlet" method="POST" >
		
							<table align="center" style="color:black;center: 10%;margin">
		
								<tr><td><br><br></td></tr>
				
								<tr>
									 <td colspan="2" align="right"><input class = "form-control form-control-sm" type="text" name="pinid" placeholder="####" pattern="[0-9\s]+" title="Please enter 4 correct charachters." required> 
									</td>
								</tr>
