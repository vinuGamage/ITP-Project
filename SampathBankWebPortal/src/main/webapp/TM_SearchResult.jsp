...
<body>
  			...
  			<div class="col-sm-6">
  				<form class="card card-sm" action="searchServlet" method="post">
  					<div class="card-body row no gutters align-times-center">
  						<div class="col">
  							<input class="form-control form-control-lg form-control-borderless" type="search" placeholder="Enter Account No" name="search">
  						</div >
  						<div class="col-auto">
  ...
  <div class="row">
    <div class="col-sm-5">
     	...
     	<p align="left" font-size="25px" margin-left=10px">Transactions Made</p>
                           <table class="table-striped"  align="center" cellpadding="10%" style="font-size: 110%;color:#404350;margin-left:10px" > 
							...
							<%
							ArrayList<Transaction> List = (ArrayList<Transaction>) session.getAttribute("SearchList");
							...
							<tr style ="font-size:115%;">
								...
								<th>Amount</th>
									...
									<%
							ArrayList<Transaction> List1 = (ArrayList<Transaction>) session.getAttribute("SearchList1");
    ...
    <div class="col-sm-5"> 
      ...
      <p align="right" font-size="50px" margin-right=0px">Transactions Made</p>
                           <table class="table-striped"  align="center" cellpadding="10%" style="font-size: 110%;color:#404350;margin-right:0px" > 
							...
							<%
							ArrayList<Transaction> List2 = (ArrayList<Transaction>) session.getAttribute("SearchList2");
							...
							<p align="right" font-size="50px" margin-right=0px">Transactions Received</p>
							...
							<tr style ="font-size:115%;">
								...
								<th>Amount</th>
									...
									<%
							ArrayList<Transaction> List3 = (ArrayList<Transaction>) session.getAttribute("SearchList3");
