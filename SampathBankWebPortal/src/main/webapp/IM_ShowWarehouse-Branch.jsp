    ...
    <body>
        ...
        <div class="container" style="overflow: auto;">
			...
			<div class="row">
					...
					<iframe src="https://www.google.com/maps/d/u/0/embed?mid=18wB28XP6Y33dGqXQ8megOWJWfUsaFpQ8" width="640" height="480" align="center"></iframe>
					</div>
					
					<div class="col-md-3">
					<br><br>
					<p style= "text-align:justify;font-size:18px" >This Map is custom created for the warehouse branch tracking. Only the authorized employee who has the correct Gmail Addrees and Password can make the changes.</p>
					<br><br>
						<div class="box" style="background-color:#A52714;color:white;font-weight:bold" align="center">Warehouse</div> 
					<br>
						<div class="box" style="background-color:black;color:white;font-weight:bold" align="center">Branches</div>
					<br><br>
					</div>
			</div>
