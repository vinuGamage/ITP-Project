...
-->
        ...
        <div class="container-fluid" style="margin-bottom: 100px; height: 100%">
			...
			<form action="/SampathBankWebPortal/EmailComposeController" method="post">
				To: <input type="email" name="receiver" placeholder="receiver@Company.com"/></br>
				From: <input type="email" name="sender" value="<%=employee.getCompanyEmail() %>" disabled/></br>
				Subject: <input type="text" name="subject"/></br>
				Content: <textarea name="content" rows="15"></textarea></br>
