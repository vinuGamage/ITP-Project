...
-->
		<nav aria-label="breadcrumb" class="breadcrumb-stuff">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">Search for Employees</li>
		  </ol>
		</nav>
        ...
        <div class="container-fluid" style="margin-bottom: 100px; height: 100%">
			...
			<div style="width: 800px; float: center; padding: 5px; border-width: 1px; border-style: solid; border-color: #FD4F00; margin: 0 auto;">
               <h5>Search for Employees</h5>
				<form class="example" action="/SampathBankWebPortal/SearchForEmployee" method="post">
			...
			<div class="container-fluid" style="margin-top: 40px;">
				<%if(employeeSearchList01 != null && value != null) {%>
					<table class="table table-hover">
					  ...
					  <tbody>
					  <%for(Employee emp: employeeSearchList01) {%>
					    <tr>
					      <th scope="row"><%=emp.getPersonId() %></th>
					      <td style="font-weight: bold;"><%=emp.getName().getFullName() %></td>
					      ...
					      <td>
					      	<form action="/SampathBankWebPortal/SearchForEmployee" method="post">
					      		<input type="hidden" value="<%=emp.getPersonId()%>" name="employeeId"/>
					      		<input type="submit" name="show" value="View Details" style="background-color: white; border-radius: 10px; color: black; border-color: #FD4F00; border-width: 1px; border-style: solid; font-size: 19px; margin-right: 20px;"/>
					      	</form>
					      </td>
					    </tr>
					    <%} %>
				...
				<%} else if(employeeSearchList01 == null && value != null){ %>
					<div style="margin-left: 30%;">
						<h4>There were no search results to be matching!</h4>
					</div>
				<%}%>
			</div>
		</div>
