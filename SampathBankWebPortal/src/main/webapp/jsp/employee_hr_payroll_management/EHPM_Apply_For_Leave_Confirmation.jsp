...
-->
		...
		<%if(leaveRequest != null) {%>
			...
			<form action="/SampathBankWebPortal/LeaveHandlingEmployee" method="get">
				<input type="submit" name="leaveRejectSeconded" value="Reject" style="background-color: white; border-radius: 10px; color: black; border-color: #FD4F00; border-width: 2px; border-style: solid; font-size: 19px;"/>
			</form>
				<button onclick="document.getElementById('id01').style.display='block'" style="background-color: white; border-radius: 10px; color: black; border-color: #FD4F00; border-width: 2px; border-style: solid; font-size: 19px; margin-right:10px;">Confirm</button>
		<%} else { %>
			Some Error!
		<%} %>
		</div>
