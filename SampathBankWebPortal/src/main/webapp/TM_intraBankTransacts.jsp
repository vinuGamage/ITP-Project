...
<!-- Required meta tags -->
    ...
    <title>Intra-Bank Transaction</title>
    
    <script type="text/javascript"> 
    	function autoFill(){
    		document.getElementById("Taccountno").value="202121212";
        ...
        <div class="container-fluid" style="height: auto ">
            ...
            <div class="row">
             ...
             <div class="col-sm-10">
                 ...
                 <div align="center">
                            <br><br><br>
                            <p style="center:2%;font-size:35px;color:#565554;font-weight:Bold;margin-left:200px">Other Bank Transacions</p>
                            
                        </div>
                        <div align="center">
                           <form  name="intraBankTransaction" action = "interServlet" method="POST" >
                        
                        	 <%Login l = (Login)session.getAttribute("username"); %>
                        
                            <table align="center" style="color:black;center: 10%;font-size:20px;margin-left:370px" cellpadding="5px" cellspacing="5px" m>
                        
                        
                            <tr> <th style = "text-align: left">Account No &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  :<span style="color: #e32;content: ' *';display:inline;">*</span></th>
                                 <td colspan="2" align="right"><input class = "form-control form-control-sm" type="text" name="accountno" readonly="readonly" value=<%=l.getAccount() %>> 
                            </td>
                            </tr>
                            
                            <tr><th style="text-align:left">Target Account No &nbsp  :<span style="color: #e32;content: ' *';display:inline;">*</span> </th>
                            ...
                            <tr><th style="text-align:left">Date &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  :<span style="color: #e32;content: ' *';display:inline;">*</span> </th>
                                <td colspan="2" align="right"><input class = "form-control form-control-sm" type="date" name="dateTime" value=<%=java.time.LocalDate.now() %> readonly="readonly">
                            </td>
                            </tr>
                            
                            
                            
                            <tr><th style="text-align:left">Amount &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp    :<span style="color: #e32;content: ' *';display:inline;">*</span> </th>
