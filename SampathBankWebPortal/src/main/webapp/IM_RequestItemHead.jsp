...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="overflow: auto;">
			...
			<tr>
				<th style="font-weight:bold">Branch Item Id</th>
				<th style="font-weight:bold">Name</th>			
				<th style="font-weight:bold">Quantity</th>
				<th style="font-weight:bold">Request Amount</th>
			</tr>
			<% 
			...
			ArrayList<BranchItem> branchItem =(ArrayList<BranchItem>) session.getAttribute("IM_branchItemList");
					...
					while(x<branchItem.size()){
						BranchItem b1 = branchItem.get(x);
			...
			<tr>
				...
				<td width="350px">
                  		...
                  		<div class="input-group">
         					 ...
         					 &nbsp &nbsp <input type="submit" class="nav-link nav_change" style="border-radius: 15px; text-align: center;font-weight:bold;color::#fd4f00;background-color:white;width:100px;border-weight:10px;border-color:#fd4f00" value="Request">
    				  </div>
