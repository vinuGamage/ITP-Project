  ...
  <nav class="navbar fixed-top navbar-expand-md navbar-dark fixed-stuff" >
        ...
        <div class="container-fluid" style="height: 850px ">
           ...
           <div class="col-sm-10">
                 ...
                 <div align="center">
                            <br><br>
                            <p style="center:2%;font-size:35px;color:black;font-weight:Bold;margin-left:200px">Enter Your E-mail</p>
                            
                        </div>
                        <div align="center">
                            <form  name="pin2" action = "transactServlet" method="POST" >
							...
							<tr>
				 				<td colspan="2" align="right"><input class = "form-control form-control-sm" type="email" name="email" placeholder="E-Mail Address" pattern="" title="Please enter a valid mail" required> 
								</td>
							</tr>
			
							<tr><td><br><br></td></tr>
			
							<tr><th style="text-align:center"><pre>Your new pin Id is sent to your mail    </pre></th>
								<td colspan="2" align="right"> <input type="submit" value="Next" class="btn btn-secondary btn-sm"> 
								</td>
							</tr>
                            </table>
